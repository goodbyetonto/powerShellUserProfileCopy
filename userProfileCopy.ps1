...
function Copy-WithProgress {
    ...
    $CommonRobocopyParams = "/MIR /b /compress /XA:SH /XD $Excludes_Folder /XJD /R:5 /W:15 /MT:13 /Z /NP /NDL /NC /BYTES /NJH /NJS"
...
Start-Transcript -Path ('{0}\{1}\{2}\{3}' -f $Transcript, $Get_User, $Hostname, $DateTime + "_copy") -NoClobber
